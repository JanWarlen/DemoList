...
public class RedisInitUtil {
        ...
        if (null != cacheCloud) {
            ...
            switch (type) {
                ...
                case SENTINEL:
                    ...
                    List<String> sentinelNodesList = Arrays.asList(sentinelNodes.split(StringConstant.COMMA_ENG));
                    sentinel.setNodes(sentinelNodesList);
    ...
    private static RedisStandaloneConfiguration getRedisStandaloneConfig(RedisProperties redisProperties) {
